...
export async function textToJson() {
  ...
  const text =
    "Neural networks are computational models inspired by the human brain.They consist of layers of nodes called neurons.Deep learning uses multiple hidden layers to capture complex patterns.";
